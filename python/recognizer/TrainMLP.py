...
def main():
    ...
    y_train = y_train[idx_junk_train]
    x_train = x_train[idx_junk_train]
    y_val = y_val[idx_junk_val]
    x_val = x_val[idx_junk_val]
    y_test = y_test[idx_junk_test]
    x_test = x_test[idx_junk_test]
